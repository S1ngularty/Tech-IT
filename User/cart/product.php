...
$sql_display = "SELECT product_name, price, product_description, product_img, date_added 
                FROM product 
...
<div class="product-controls">
    <input type="number" name="quantity" value="1" min="1" step="1" style="width: 50px; margin-right:10px;">
