...
if(isset($_POST['update'])){
 ...
 echo $current_path="uploads/".((!empty($file_delete)=== true) ? $file_delete : 'qweqweqwe' );
 if (
    ...
    try{
        ...
        mysqli_stmt_bind_param($stmt2,'ssissi',$fname,$lname,$age,$gender,$contact,$_SESSION['update_id']);
